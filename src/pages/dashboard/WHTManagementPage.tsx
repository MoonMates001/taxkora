...
const WHTManagementPage = () => {
  ...
  const generateRemittanceReport = () => {
    ...
    doc.text("WHT must be remitted to NRS within 21 days of deduction.", 14, finalY);
        ...
        <TabsContent value="schedule" className="space-y-6">
          <Card className="shadow-card">
            <CardHeader>
              ...
              <CardDescription>
                WHT must be remitted to NRS within 21 days of deduction
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-blue-800">
                  ...
                  <ul className="mt-2 space-y-1 text-sm">
                    <li>• WHT deducted must be remitted to NRS by the 21st of the following month</li>
